...
/**
 * нажатие вкладки ЖУРНАЛ ОПЕРАЦИЙ получаем из базы данных "ОПЕРАЦИИ" и вставляем в таблицу*/
...
/**
 * нажатие вкладки СОБЫТИЯ" получаем из базы данных список "СОБЫТИЯ" и вставляем в таблицу*/
...
/**
 *Функция отмечающая в базе элементы checkBox  и обновляющая строку*/                
