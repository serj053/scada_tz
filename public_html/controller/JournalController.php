...
/*заносим в базу данных данные и действия*/
    private function addAction(){
        ...
        /*Соеденение с базой*/        
                $obj = new DB_connect;
        /*Заносим в базу жанные , которые беруться из массива GET[] в моделе*/        
                $obj->insertMsg();
...
/*Получаем из базы данные для вкладки "ВСЕ"*/
...
*получаем из базы данных "ОПЕРАЦИИ" и вставляем в таблицу*/		
 ...
 /*передаем в таблицу по "id" строки отмеченны как  checked и выносим изменения
*на страницу  */
